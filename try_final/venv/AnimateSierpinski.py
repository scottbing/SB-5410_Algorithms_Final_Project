...
def animate_sierpinski(iterations, axiom, rules, angle, speed, fill, length=None, size=None, correction_angle=0,
         y_offset=None, x_offset=None, offset_angle=None, inverted=False, flip_h=False,
         flip_v=False, width=None, height=None, margin=None, aspect_ratio=None, color="green"):
